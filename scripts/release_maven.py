...
# Need to register namespaces for XML on ElementTree library. Use the `default_ns` when searching for an element
...
print(f"Parsing file: {path.join(maven_module_path, pom_file_name)}")
