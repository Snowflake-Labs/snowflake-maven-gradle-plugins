...
public abstract class UserDefined {
    ...
    /**
     * This factory method is only used to create an instance from CLI arguments
    ...
    */
    public static UserDefined create(String type, String name, String args, String handler, String returns) {
        ...
        switch (type.toLowerCase()) {
            case procedure: udx = new Procedure();
                break;
            case function: udx = new Function();
                break;
            default: throw new IllegalArgumentException("The specified type is not recognized. The type of the user defined creation may be \"procedure\" or \"function\"");
        }
        udx.name = name;
        udx.handler = handler;
        udx.returns = returns;
